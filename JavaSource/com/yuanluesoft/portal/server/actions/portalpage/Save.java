 ...
 *
 */
public class Save extends PortalPageAction {
	...
	public void submitForm(com.yuanluesoft.jeaf.form.ActionForm form, SessionInfo sessionInfo, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if("create".equals(portalPageForm.getAct())) {
			portalService.addPortalPage(portalPageForm.getApplicationName(), portalPageForm.getPageName(), portalPageForm.getUserId(), portalPageForm.getSiteId(), portalPageForm.getTitle(), portalPageForm.getStyle(), portalPageForm.getLayout(), portalPageForm.isAlwaysDisplayPortletButtons(), portalPageForm.getInitPortletEntityCategory(), sessionInfo);
		}
		else if("edit".equals(portalPageForm.getAct())) {
			portalService.editPortalPage(portalPageForm.getApplicationName(), portalPageForm.getPageName(), portalPageForm.getUserId(), portalPageForm.getSiteId(), portalPageForm.getId(), portalPageForm.getTitle(), portalPageForm.getStyle(), portalPageForm.getLayout(), portalPageForm.isAlwaysDisplayPortletButtons(), sessionInfo);
		}
	}
}