 ...
 *
 */
public class RestoreDefaultPortal extends PortalPageAction {
	...
	public void submitForm(com.yuanluesoft.jeaf.form.ActionForm form, SessionInfo sessionInfo, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		portalService.deletePortal(portalPageForm.getApplicationName(), portalPageForm.getPageName(), portalPageForm.getUserId(), portalPageForm.getSiteId(), sessionInfo);
	}
}