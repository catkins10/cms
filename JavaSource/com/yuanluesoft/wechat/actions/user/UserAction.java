...
public class UserAction extends FormAction {
	...
	public char checkLoadPrivilege(ActionForm form, HttpServletRequest request, Record record, String openMode, List acl, SessionInfo sessionInfo) throws PrivilegeException, SystemUnregistException {
		try {
			WechatUser user = (WechatUser)record;
			if(acl.contains(AccessControlService.ACL_APPLICATION_MANAGER) || getOrgService().isOrgManager(user.getUnitId(), sessionInfo)) {
	...
	public void checkDeletePrivilege(ActionForm form, HttpServletRequest request, Record record, List acl, SessionInfo sessionInfo) throws PrivilegeException, SystemUnregistException {
		...
		WechatUser user = (WechatUser)record;
		if(user.getUnsubscribeTime()==null) { //没有取消关注
			throw new PrivilegeException();
		}
	}
}