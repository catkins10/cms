package com.yuanluesoft.j2oa.infocontribute.forms;
 ...
 *
 */
public class Info extends ActionForm {
	...
	//扩展属性
	private String[] presetMagazineIds; //预选刊型ID列表
	private String[] receiveUnitNames; //接收单位名称列表
	...
	/**
	 * @return the presetMagazineIds
	 */
	public String[] getPresetMagazineIds() {
		return presetMagazineIds;
	}

	/**
	 * @param presetMagazineIds the presetMagazineIds to set
	 */
	public void setPresetMagazineIds(String[] presetMagazineIds) {
		this.presetMagazineIds = presetMagazineIds;
	}
	...
	/**
	 * @return the receiveUnitNames
	 */
	public String[] getReceiveUnitNames() {
		return receiveUnitNames;
	}

	/**
	 * @param receiveUnitNames the receiveUnitNames to set
	 */
	public void setReceiveUnitNames(String[] receiveUnitNames) {
		this.receiveUnitNames = receiveUnitNames;
	}
}