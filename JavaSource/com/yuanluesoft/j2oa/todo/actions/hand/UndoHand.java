 ...
 *
 */
public class UndoHand extends HandAction {
	   
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return executeSaveAction(mapping, form, request, response, false, null, "完成撤销！", null);
    }
	...
	public Record saveRecord(com.yuanluesoft.jeaf.form.ActionForm form, Record record, String openMode, HttpServletRequest request, HttpServletResponse response, SessionInfo sessionInfo) throws Exception {
		...
		pojoTodo.setIsSent('0');
		super.saveRecord(form, record, openMode, request, response, sessionInfo);
		//通知接收人
		if(pojoTodo.getHandPersons()!=null) {
			String message = "撤销:" + pojoTodo.getSubject() + "(" + pojoTodo.getPersonName() + "交办)";
