...
/**
 * 消息反馈(exchange_message)
 * @author linchuan
 *
 */
public class ExchangeMessage extends Record {
	...
	private ExchangeDocument document; //公文
	 ...
	 * @return
	 */
	public ExchangeMessage getReply() {
		System.out.println("**********replies:" + replies);
		return replies==null || replies.isEmpty() ? null : (ExchangeMessage)replies.iterator().next();
	}
