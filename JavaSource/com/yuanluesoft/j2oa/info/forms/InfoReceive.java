 ...
 *
 */
public class InfoReceive extends ActionForm {
	...
	//扩展属性
	private long previousInfoId; //上一个信息ID
	private long nextInfoId; //下一个信息ID
	...
	/**
	 * @return the nexInfoId
	 */
	public long getNextInfoId() {
		return nextInfoId;
	}
	/**
	 * @param nexInfoId the nexInfoId to set
	 */
	public void setNextInfoId(long nexInfoId) {
		this.nextInfoId = nexInfoId;
	}
	/**
	 * @return the previousInfoId
	 */
	public long getPreviousInfoId() {
		return previousInfoId;
	}
	/**
	 * @param previousInfoId the previousInfoId to set
	 */
	public void setPreviousInfoId(long previousInfoId) {
		this.previousInfoId = previousInfoId;
	}
	/**
	 * @return the revises
	 */
