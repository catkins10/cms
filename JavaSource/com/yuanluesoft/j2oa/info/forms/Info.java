 ...
 *
 */
public class Info extends WorkflowForm {
	...
	private int status; //状态,0/审核中,1/待排版,2/已排版
	...
	private InfoReceive infoReceive = new InfoReceive(); //来稿
	...
	//扩展属性
	private boolean isMagazineEditor; //用户是否刊物的编辑或者主编
	private List combineInfos; //被合并的稿件 
	...
	/**
	 * @return the isMagazineEditor
	 */
	public boolean isMagazineEditor() {
		return isMagazineEditor;
	}
	/**
	 * @param isMagazineEditor the isMagazineEditor to set
	 */
	public void setMagazineEditor(boolean isMagazineEditor) {
		this.isMagazineEditor = isMagazineEditor;
	}
	/**
	 * @return the combineInfos
	 */
	public List getCombineInfos() {
		return combineInfos;
	}
	/**
	 * @param combineInfos the combineInfos to set
	 */
	public void setCombineInfos(List combineInfos) {
