...
public class Point extends ActionForm {
	...
	//扩展属性
	private String higherMagazineNames; //上级刊物名称列表
	...
	/**
	 * @return the higherMagazineNames
	 */
	public String getHigherMagazineNames() {
		return higherMagazineNames;
	}
	/**
	 * @param higherMagazineNames the higherMagazineNames to set
	 */
	public void setHigherMagazineNames(String higherMagazineNames) {
		this.higherMagazineNames = higherMagazineNames;
	}
}