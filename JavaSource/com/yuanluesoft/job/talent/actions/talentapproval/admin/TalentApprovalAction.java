package com.yuanluesoft.job.talent.actions.talentapproval.admin;
 ...
 *
 */
public class TalentApprovalAction extends FormAction {
	...
	public Record loadRecord(ActionForm form, Form formDefine, long id, SessionInfo sessionInfo, HttpServletRequest request) throws Exception {
		...
		return jobParameterService.getJobTalentApproval();
	}
}