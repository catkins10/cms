 ...
 *
 */
public class Talent extends ActionForm {
	...
	private int status; //状态,0/注册,1/审核通过,2/审核未通过,3/停用
	...
	//扩展属性,注册时有效
	private JobTalentIntention intention = new JobTalentIntention(); //求职意向
	private JobTalentSchooling schooling = new JobTalentSchooling(); //教育经历
	private JobTalentCareer career = new JobTalentCareer(); //工作经历
	
	/**
	 * @return the career
	 */
	public JobTalentCareer getCareer() {
		return career;
	}
	/**
	 * @param career the career to set
	 */
	public void setCareer(JobTalentCareer career) {
		this.career = career;
	}
	/**
	 * @return the intention
	 */
	public JobTalentIntention getIntention() {
		return intention;
	}
	/**
	 * @param intention the intention to set
	 */
	public void setIntention(JobTalentIntention intention) {
		this.intention = intention;
	}
	/**
	 * @return the schooling
	 */
	public JobTalentSchooling getSchooling() {
		return schooling;
	}
	/**
	 * @param schooling the schooling to set
	 */
	public void setSchooling(JobTalentSchooling schooling) {
