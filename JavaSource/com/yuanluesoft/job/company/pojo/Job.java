...
public class Job extends Record {
	...
	private int qualification = -1; //学历要求,初中,高中,职业高中,职业中专,中专,大专,本科,MBA,硕士,博士
	...
	public String getMonthlyPayRange() {
		if(minMonthlyPay==0 && maxMonthlyPay==0) {
			return "面议";
		}
		else if(maxMonthlyPay==0) { //未设置上限
			return minMonthlyPay + "元";
		}
		else {
			return minMonthlyPay + "元 ~ " + maxMonthlyPay + "元";
		}
	}
