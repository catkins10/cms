package com.yuanluesoft.job.company.actions.companyapproval.admin;
 ...
 *
 */
public class CompanyApprovalAction extends FormAction {
	...
	public Record loadRecord(ActionForm form, Form formDefine, long id, SessionInfo sessionInfo, HttpServletRequest request) throws Exception {
		...
		return jobParameterService.getJobCompanyApproval();
	}
}