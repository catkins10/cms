...
public class Project extends ActionForm {
	...
	private String sign; //签约情况,初步接洽、签订意向、签订合同
	...
	private long problemId; //存在的问题ID
	private Timestamp problemCreated; //录入时间
	private String problem; //存在的问题描述
	
	private long investmentId; //资金到达ID
	private Date investmentReceiveTime; //资金到达时间
	private double investmentReceiveMoney; //资金到达数额
	private double investmentReceiveChecked; //已验资资金(万美元)
	...
	/**
	 * @return the investmentReceiveMoney
	 */
	public double getInvestmentReceiveMoney() {
		return investmentReceiveMoney;
	}
	/**
	 * @param investmentReceiveMoney the investmentReceiveMoney to set
	 */
	public void setInvestmentReceiveMoney(double investmentReceiveMoney) {
		this.investmentReceiveMoney = investmentReceiveMoney;
	}
	/**
	 * @return the investmentReceiveTime
	 */
	public Date getInvestmentReceiveTime() {
		return investmentReceiveTime;
	}
	/**
	 * @param investmentReceiveTime the investmentReceiveTime to set
	 */
	public void setInvestmentReceiveTime(Date investmentReceiveTime) {
		this.investmentReceiveTime = investmentReceiveTime;
	}
	/**
	...
	/**
	 * @return the problemCreated
	 */
	public Timestamp getProblemCreated() {
		return problemCreated;
	}
	/**
	 * @param problemCreated the problemCreated to set
	 */
	public void setProblemCreated(Timestamp problemCreated) {
		this.problemCreated = problemCreated;
	}
	/**
	 * @return the investmentReceiveChecked
	 */
	public double getInvestmentReceiveChecked() {
		return investmentReceiveChecked;
	}
	/**
	 * @param investmentReceiveChecked the investmentReceiveChecked to set
	 */
	public void setInvestmentReceiveChecked(double investmentReceiveChecked) {
		this.investmentReceiveChecked = investmentReceiveChecked;
	}
	/**
