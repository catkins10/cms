 ...
 *
 */
public class Timetable extends ActionForm {
	...
	//适用的用户列表
	private RecordVisitorList timetableVisitors = new RecordVisitorList();
	...
	/**
	 * @return the timetableVisitors
	 */
	public RecordVisitorList getTimetableVisitors() {
		return timetableVisitors;
	}
	/**
	 * @param timetableVisitors the timetableVisitors to set
	 */
	public void setTimetableVisitors(RecordVisitorList timetableVisitors) {
		this.timetableVisitors = timetableVisitors;
	}
}