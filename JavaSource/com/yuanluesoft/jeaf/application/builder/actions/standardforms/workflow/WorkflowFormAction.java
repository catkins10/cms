package com.yuanluesoft.jeaf.application.builder.actions.standardforms.workflow;
 ...
 *
 */
public class WorkflowFormAction extends WorkflowAction {
	...
	public String getWorkflowActionName(WorkflowForm workflowForm) {
		String formName = workflowForm.getFormDefine().getName();
		return "run" + StringUtils.capitalizeFirstLetter(formName);
	}
