 ...
 *
 */
public class PaymentMethodParameterDefine {
	...
	public PaymentMethodParameterDefine(String label, String name, String remark, String defaultValue, boolean isPassword) {
		super();
		this.label = label;
		this.name = name;
		this.remark = remark;
