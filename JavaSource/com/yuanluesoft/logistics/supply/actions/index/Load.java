package com.yuanluesoft.logistics.supply.actions.index;
...
public class Load extends BaseAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		pageService.writePage("logistics/supply", SessionService.ANONYMOUS.equals(sessionInfo.getLoginName()) ? "indexAnonymous" : "index", request, response, false);
        return null;
    }
}