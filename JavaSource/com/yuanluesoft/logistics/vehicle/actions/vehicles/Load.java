package com.yuanluesoft.logistics.vehicle.actions.vehicles;
...
public class Load extends BaseAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		pageService.writePage("logistics/vehicle", SessionService.ANONYMOUS.equals(sessionInfo.getLoginName()) ? "vehiclesAnonymous" : "vehicles", request, response, false);
        return null;
    }
}