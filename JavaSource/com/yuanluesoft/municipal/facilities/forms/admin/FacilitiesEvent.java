 ...
 *
 */
public class FacilitiesEvent extends WorkflowForm {
	...
	//PDA验证者
	public long pdaValidateUserId;
	public String pdaValidateUserName;
	...
	/**
	 * @return the pdaValidateUserId
	 */
	public long getPdaValidateUserId() {
		return pdaValidateUserId;
	}
	/**
	 * @param pdaValidateUserId the pdaValidateUserId to set
	 */
	public void setPdaValidateUserId(long pdaValidateUserId) {
		this.pdaValidateUserId = pdaValidateUserId;
	}
	/**
	 * @return the pdaValidateUserName
	 */
	public String getPdaValidateUserName() {
		return pdaValidateUserName;
	}
	/**
	 * @param pdaValidateUserName the pdaValidateUserName to set
	 */
	public void setPdaValidateUserName(String pdaValidateUserName) {
		this.pdaValidateUserName = pdaValidateUserName;
	}
	/**
