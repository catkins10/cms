 ...
 *
 */
public class LearnMission extends ActionForm {
	...
	//扩展属性
	private RecordVisitorList learners = new RecordVisitorList(); //参加学习的人员
	 ...
	 * @return the learners
	 */
	public RecordVisitorList getLearners() {
		return learners;
	}
	/**
	 * @param learners the learners to set
	 */
	public void setLearners(RecordVisitorList learners) {
