 ...
 *
 */
public class ExamPaper extends Record {
	...
	/**
	 * @return the examTests
	 */
	public Set getExamTests() {
		return examTests;
	}
	/**
	 * @param examTests the examTests to set
	 */
	public void setExamTests(Set examTests) {
