package com.yuanluesoft.cms.smssubscription.forms.admin;
 ...
 *
 */
public class SmsService extends ActionForm {
	...
	private String subscribeRule; //完整订阅规则
	...
	/**
	 * @return the subscribeRule
	 */
	public String getSubscribeRule() {
		return subscribeRule;
	}
	/**
	 * @param subscribeRule the subscribeRule to set
	 */
