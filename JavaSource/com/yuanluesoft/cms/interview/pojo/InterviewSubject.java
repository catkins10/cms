...
/**
 * 在线访谈:主题(interview_subject)
 * @author linchuan
 *
 */
public class InterviewSubject extends Record {
	...
	public String getHasImages() {
		try {
			return interviewImages==null || interviewImages.isEmpty() ? "" : (interviewImages.size()==1 ? "图" : "多图");  
		}
		catch(Exception e) {
			return "";
		}
	...
	public String getHasVideos() {
		try {
			return interviewVideos==null || interviewVideos.isEmpty() ? "" : "视频";  
		}
		catch(Exception e) {
			return "";
		}
