 ...
 *
 */
public class AdvertPut extends ActionForm {
	...
	//扩展属性,投放时有效
	private String quotedPrice; //报价说明
	private com.yuanluesoft.cms.advert.pojo.AdvertPut currentAdvertPut; //广告位当前投放的广告
	...
	/**
	 * @return the currentAdvertPut
	 */
	public com.yuanluesoft.cms.advert.pojo.AdvertPut getCurrentAdvertPut() {
		return currentAdvertPut;
	}
	/**
	 * @param currentAdvertPut the currentAdvertPut to set
	 */
	public void setCurrentAdvertPut(
			com.yuanluesoft.cms.advert.pojo.AdvertPut currentAdvertPut) {
		this.currentAdvertPut = currentAdvertPut;
	}
}