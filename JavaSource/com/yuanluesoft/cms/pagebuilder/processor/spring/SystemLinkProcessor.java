 ...
 *
 */
public class SystemLinkProcessor implements PageElementProcessor { 
	...
	public void writePageElement(HTMLElement pageElement, WebDirectory webDirectory, WebSite parentSite, HTMLParser htmlParser, SitePage sitePage, RequestInfo requestInfo, HttpServletRequest request) throws ServiceException {
		...
		String href = a.getHref().replaceAll("&amp;", "&");
		int index = href.indexOf("://");
		if(index!=-1) {
			href = href.substring(href.indexOf('/', index + 3));
		}
		long siteId = (relationSiteId==-1 ? parentSite.getId() : relationSiteId);
		//输出链接
		LinkUtils.writeLink(a, href, a.getTarget(), webDirectory.getId(), siteId, null, false, true, sitePage, request);
	}
