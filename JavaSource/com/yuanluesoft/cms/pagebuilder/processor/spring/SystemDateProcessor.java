 ...
 *
 */
public class SystemDateProcessor implements PageElementProcessor { 
	...
	public void writePageElement(HTMLElement pageElement, WebDirectory webDirectory, WebSite parentSite, HTMLParser htmlParser, SitePage sitePage, RequestInfo requestInfo, HttpServletRequest request) throws ServiceException {
		pageElement.getParentNode().replaceChild(pageElement.getOwnerDocument().createTextNode(DateTimeUtils.formatTimestamp(DateTimeUtils.now(), pageElement.getAttribute("urn"))), pageElement);
	}
