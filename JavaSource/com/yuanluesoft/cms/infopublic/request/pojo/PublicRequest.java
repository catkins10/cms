...
/**
 * 信息公开:申请公开(public_request)
 * @author linchuan
 *
 */
public class PublicRequest extends PublicService {
	private char proposerType = '1'; //申请人类型,公民,法人/其他组织
	...
	public String getFrom() {
		return proposerType=='1' ? getCreator() : getCreatorUnit();
	}
	...
	public String getProposerTypeName() {
		return proposerType=='1' ? "personal" : "company";
	}
