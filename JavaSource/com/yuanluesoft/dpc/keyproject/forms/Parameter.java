...
public class Parameter extends ActionForm {
	...
	private List industries; //行业配置列表
	private List investSources; //资金来源配置列表
	private List developmentAreaCategories; //开发区分类列表
	...
	/**
	 * @return the investSources
	 */
	public List getInvestSources() {
		return investSources;
	}
	/**
	 * @param investSources the investSources to set
	 */
	public void setInvestSources(List investSources) {
		this.investSources = investSources;
	}
	/**
	 * @return the developmentAreaCategories
	 */
	public List getDevelopmentAreaCategories() {
		return developmentAreaCategories;
	}
	/**
	 * @param developmentAreaCategories the developmentAreaCategories to set
	 */
	public void setDevelopmentAreaCategories(List developmentAreaCategories) {
		this.developmentAreaCategories = developmentAreaCategories;
	}
	/**
