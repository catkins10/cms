package com.yuanluesoft.dpc.keyproject.report.actions.zzfetprogressreport;
...
import com.yuanluesoft.dpc.keyproject.report.forms.ZzfetProgressReport;
 ...
 *
 */
public class Write extends ZzfetProgressReportAction {
	...
	public void submitForm(com.yuanluesoft.jeaf.form.ActionForm form, SessionInfo sessionInfo, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ZzfetProgressReport report = (ZzfetProgressReport)form;
		zzfetKeyProjectReportService.writeProgressReport(report.getYear(), report.getMonth(), report.getKeyMonth(), report.getDevelopmentArea(), null, response, sessionInfo);
	}
}