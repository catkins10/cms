package com.yuanluesoft.dpc.keyproject.report.actions.investreport;
...
import com.yuanluesoft.dpc.keyproject.report.forms.InvestReport;
 ...
 *
 */
public class Write extends InvestReportAction {
	...
	public void submitForm(com.yuanluesoft.jeaf.form.ActionForm form, SessionInfo sessionInfo, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        InvestReport report = (InvestReport)form;
        npdpcKeyProjectReportService.writeInvestReport(report.getYear(), response);
	}
}