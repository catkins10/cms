package com.yuanluesoft.dpc.keyproject.report.actions.zzfetaccountablereport;
...
import com.yuanluesoft.dpc.keyproject.report.forms.ZzfetAccountableReport;
 ...
 *
 */
public class Write extends ZzfetAccountableReportAction {
	...
	public void submitForm(com.yuanluesoft.jeaf.form.ActionForm form, SessionInfo sessionInfo, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ZzfetAccountableReport report = (ZzfetAccountableReport)form;
		zzfetKeyProjectReportService.writeAccountableReport(report.getYear(), report.getMonth(), report.getKeyMonth(), report.getDevelopmentArea(), null, response, sessionInfo);
	}
}