 ...
 *
 */
public class DevelopmentAreaCategoryAction extends ParameterAction {
	...
	public Record loadComponentRecord(ActionForm form, Record mainRecord, String componentName, SessionInfo sessionInfo, HttpServletRequest request) throws Exception {
		...
		return (Record)ListUtils.findObjectByProperty(keyProjectService.listDevelopmentAreaCategories(), "id", PropertyUtils.getProperty(form, componentName + ".id"));
	}
}