...
/**
 * 项目(keyproject_project)
 * @author linchuan
 *
 */
public class KeyProject extends WorkflowData {
	...
	private String declareOrDebrief; //申报还是汇报,流程流转时做判断条件用
	...
	public String getArea() {
		return ListUtils.join(areas, "area", ",", false);
	}
	 ...
	 * @return
	 */
	public double getInvestAsHundredMillion() {
		return invest/10000.0;
	}
	...
	/**
	 * @return the declareOrDebrief
	 */
	public String getDeclareOrDebrief() {
		return declareOrDebrief;
	}

	/**
	 * @param declareOrDebrief the declareOrDebrief to set
	 */
	public void setDeclareOrDebrief(String declareOrDebrief) {
		this.declareOrDebrief = declareOrDebrief;
	}
