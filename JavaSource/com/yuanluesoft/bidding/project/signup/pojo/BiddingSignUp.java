 ...
 *
 */
public class BiddingSignUp extends Record {
	...
	private char pledgeConfirm = '0'; //保证金确认, 0/未确认, 1/已确认 2/本项目中排除 3/已被其他项目确认
	...
	private BiddingProjectAgent biddingAgent; //招标代理
	private BiddingProject project; //项目信息
	private Set jobholders; //参与人员
	...
	public String getPaymentMode() {
		return paymentTime==null ? null : (isInternetPayment=='1' ? "网络支付" : "转账");
	}
	 ...
	 * @return
	 */
	public String getDrawPaymentMode() {
		return drawPaymentTime==null ? null : (isDrawInternetPayment=='1' ? "网络支付" : "转账");
	}
	 ...
	 * @return
	 */
	public String getPledgePaymentMode() {
		return pledgePaymentTime==null ? null : (isPledgeInternetPayment=='1' ? "网络支付" : "转账");
	}
	 ...
	 */
	public void setBiddingAgent(BiddingProjectAgent agent) {
