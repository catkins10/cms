 ...
 *
 */
public class ApprovalNotice extends ProjectAction {
...
/*		Project projectForm = (Project)workflowForm;
		BiddingProject project = (BiddingProject)pojo;
		ProjectParameterService biddingProjectParameterService = (BiddingParameterService)getService("biddingProjectParameterService");
		//通知书编号
		projectForm.getNotice().setNoticeNumber(parameterService.generateNoticeNumber(project, false));
