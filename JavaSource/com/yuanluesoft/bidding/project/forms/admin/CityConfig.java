 ...
 *
 */
public class CityConfig extends ActionForm {
	...
	//扩展属性
	private RecordVisitorList managers = new RecordVisitorList(); //管理员
	private RecordVisitorList reportVisitors = new RecordVisitorList(); //报表查询人员
	private RecordVisitorList projectCreators = new RecordVisitorList(); //项目登记人员
	private RecordVisitorList projectApprovers = new RecordVisitorList(); //项目审核人员
	 ...
	 * @return the managers
	 */
	public RecordVisitorList getManagers() {
		return managers;
	}
	/**
	 * @param managers the managers to set
	 */
	public void setManagers(RecordVisitorList managers) {
		this.managers = managers;
	}
	/**
	 * @return the projectApprovers
	 */
	public RecordVisitorList getProjectApprovers() {
		return projectApprovers;
	}
	/**
	 * @param projectApprovers the projectApprovers to set
	 */
	public void setProjectApprovers(RecordVisitorList projectApprovers) {
		this.projectApprovers = projectApprovers;
	}
	/**
	 * @return the projectCreators
	 */
	public RecordVisitorList getProjectCreators() {
		return projectCreators;
	}
	/**
	 * @param projectCreators the projectCreators to set
	 */
	public void setProjectCreators(RecordVisitorList projectCreators) {
		this.projectCreators = projectCreators;
	}
	/**
	 * @return the reportVisitors
	 */
	public RecordVisitorList getReportVisitors() {
		return reportVisitors;
	}
	/**
	 * @param reportVisitors the reportVisitors to set
	 */
	public void setReportVisitors(RecordVisitorList reportVisitors) {
		this.reportVisitors = reportVisitors;
	}
	/**
