package com.yuanluesoft.credit.enterprise.searchenterprise.forms;
...
/**
 * 企业信息（内资）(credit_enterprise_in)
 * @author zyh
 *
 */
public class EnterpriseIn extends ActionForm {
	private String loginName;//登录用户名
	private String password;//密码
	
	private String registCode;//注册号
	private String creditCode;//统一社会信用代码
	private String name;//登记名称
	private String category;//企业类别
	private String registType;//登记类型

	private String type;//企业类型
	private String person;//法定代表人\负责人
	private double worth;//注册资本(万元)
