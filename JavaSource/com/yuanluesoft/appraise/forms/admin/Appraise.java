 ...
 *
 */
public class Appraise extends ActionForm {
	...
	//扩展属性
	private boolean cancelNoAppraisersUnit = false; //是否不考核没有评议员的单位
	
	/**
	 * @return the cancelNoAppraisersUnit
	 */
	public boolean isCancelNoAppraisersUnit() {
		return cancelNoAppraisersUnit;
	}
	/**
	 * @param cancelNoAppraisersUnit the cancelNoAppraisersUnit to set
	 */
	public void setCancelNoAppraisersUnit(boolean cancelNoAppraisersUnit) {
		this.cancelNoAppraisersUnit = cancelNoAppraisersUnit;
	}
	/**
