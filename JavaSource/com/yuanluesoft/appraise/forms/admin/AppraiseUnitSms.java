 ...
 *
 */
public class AppraiseUnitSms extends ActionForm {
	...
	//扩展属性
	private String participateUnits; //参评单位列表
	...
	/**
	 * @return the participateUnits
	 */
	public String getParticipateUnits() {
		return participateUnits;
	}
	/**
	 * @param participateUnits the participateUnits to set
	 */
