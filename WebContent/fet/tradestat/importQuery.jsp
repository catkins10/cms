...
<ext:form action="/displayImportQuery" applicationName="fet/tradestat" pageName="statQuery">
	<table border="0" cellpadding="0" cellspacing="3">
		<tr>
			...
			<td>&nbsp;<ext:button name="查询" width="50" onclick="FormUtils.doAction('importQuery')"/></td>
			<td>&nbsp;<ext:button name="导出数据" width="68" onclick="forms[0].action=forms[0].action.substring(0,forms[0].action.lastIndexOf('/'))+'/downloadImportData.shtml';forms[0].submit();"/></td>
			<td>
				&nbsp;&nbsp;
