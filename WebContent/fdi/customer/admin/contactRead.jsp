...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
	...
	<tr>
		...
		<td><ext:field writeonly="true" property="companyContact.name"/></td>
		<td nowrap="nowrap" align="right">英文姓名：</td>
		<td><ext:field writeonly="true" property="companyContact.englishName"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">性别：</td>
		<td><ext:field writeonly="true" property="companyContact.sex"/></td>
		<td nowrap="nowrap" align="right">个人地址：</td>
		<td><ext:field writeonly="true" property="companyContact.address"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">电话：</td>
		<td><ext:field writeonly="true" property="companyContact.tel" title="含国别、地区号"/></td>
		<td nowrap="nowrap" align="right">手机：</td>
		<td><ext:field writeonly="true" property="companyContact.mobile"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">传真：</td>
		<td><ext:field writeonly="true" property="companyContact.fax" title="含国别、地区号"/></td>
		<td nowrap="nowrap" align="right">E-mail：</td>
		<td><ext:field writeonly="true" property="companyContact.email"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">QQ\MSN\微博：</td>
		<td><ext:field writeonly="true" property="companyContact.im"/></td>
		<td nowrap="nowrap" align="right">所在部门及职务：</td>
		<td><ext:field writeonly="true" property="companyContact.post"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">个人备注：</td>
		<td colspan="3"><ext:field writeonly="true" property="companyContact.remark" title="特点、兴趣、任期等"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">商谈事项：</td>
		<td colspan="3"><ext:field writeonly="true" property="companyContact.discuss"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">信息来源：</td>
		<td><ext:field writeonly="true" property="companyContact.source"/></td>
		<td nowrap="nowrap" align="right">最初中方联系人：</td>
		<td><ext:field writeonly="true" property="companyContact.chinaContact"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">收录时间：</td>
		<td><ext:field writeonly="true" property="companyContact.created"/></td>
		<td nowrap="nowrap" align="right">录入者：</td>
		<td><ext:field writeonly="true" property="companyContact.creator"/></td>
	</tr>
