...
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		...
		<td colspan="3" class="tdcontent"><ext:write property="subject"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">是否允许公开</td>
		<td colspan="3" class="tdcontent"><ext:field property="isPublic"  writeonly="true"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="3" class="tdcontent"><pre><ext:write property="content"/></pre></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="tdcontent"><ext:write property="happenTime" format="yyyy-MM-dd HH:mm"/></td>
