...
<table valign="middle" width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	<tr>
		...
		<td colspan="3" class="tdcontent" width="100%"><ext:field writeonly="true" property="subject"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="tdcontent" width="50%" nowrap="nowrap"><ext:field writeonly="true" property="mark"/></td>
		<td class="tdtitle" nowrap="nowrap">匿名访问级别</td>
		<td class="tdcontent" width="50%" nowrap="nowrap"><ext:field writeonly="true" property="anonymousLevel"/></td>
	</tr>
	<tr>
...
<%			com.yuanluesoft.cms.siteresource.forms.Resource siteResource = (com.yuanluesoft.cms.siteresource.forms.Resource)request.getAttribute("article");
	...
	<tr>
		<td class="tdtitle" nowrap="nowrap">译者</td>
		<td class="tdcontent"><ext:field writeonly="true" property="translator"/></td>
		<td class="tdtitle" nowrap="nowrap">校对</td>
		<td class="tdcontent"><ext:field writeonly="true" property="review"/></td>
	</tr>
	<tr>
