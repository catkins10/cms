...
<table valign="middle" width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<col width="50%">
	<tr>
		<td class="tdtitle" valign="top" nowrap="nowrap">标题</td>
	...
	<tr>
		...
		<td class="tdtitle" nowrap="nowrap">默认图片</td>
		<td class="tdcontent"><ext:field property="firstImageName"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">文号</td>
		<td colspan="3" class="tdcontent"><ext:field property="mark"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">所属栏目</td>
		<td colspan="3" class="tdcontent"><ext:field property="columnFullName"/></td>
	</tr>
	<tr>
