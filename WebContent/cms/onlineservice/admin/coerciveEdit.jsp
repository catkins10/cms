	...
	<ext:tabBody tabId="basic">
		<table valign="middle" width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
			...
			<tr>
				...
				<td class="tdcontent" colspan="5"><ext:field property="serviceItemGuide.coerciveMeasure"/></td>
			</tr>
			<tr>
				<td class="tdtitle" nowrap="nowrap">裁量规则</td>
				<td class="tdcontent" colspan="5"><ext:field property="serviceItemGuide.discretionRule"/></td>
			</tr>
			<tr>
