	...
	<ext:tabBody tabId="basic">
		<table valign="middle" width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
			...
			<tr>
				...
				<td class="tdtitle" nowrap="nowrap">公共服务类型</td>
			...
			<tr>
				...
				<td class="tdcontent"><ext:field writeonly="true" property="serviceItemTransactorNames"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tdcontent"><ext:field writeonly="true" property="serviceItemGuide.acceptLimit"/></td>
			...
			<tr>
				...
				<td class="tdcontent"><ext:field writeonly="true" property="acceptSupport"/></td>
