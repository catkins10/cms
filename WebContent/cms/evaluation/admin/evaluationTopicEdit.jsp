...
<table valign="middle" width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		...
		<td class="tdcontent"><ext:field property="anonymous" onclick="document.getElementById('trEvaluatePersons').style.display=document.getElementsByName('anonymous')[0].checked ? 'none':'';"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="tdcontent"><ext:field property="targetPersons.visitorNames" title="被测评人"/></td>
	</tr>
	<tr id="trEvaluatePersons" style="<ext:equal value="1" property="anonymous">display:none</ext:equal>">
		...
		<td class="tdcontent"><ext:field property="evaluatePersons.visitorNames" title="测评人"/></td>
	</tr>
	<tr>
