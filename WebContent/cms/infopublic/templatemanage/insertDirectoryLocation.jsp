...
<ext:form action="/templatemanage/insertSiteLocation">
	<script>
		...
		window.onload = function() {
			...
			var separator = "";
			if(obj && obj.id=="infoDirectoryLocation") {
				var urn = obj.getAttribute("urn");
				separator = StringUtils.getPropertyValue(urn, "separator"); //分隔符格式
				document.getElementsByName("selfOnly")[0].checked = "true"==StringUtils.getPropertyValue(urn, "selfOnly"); //是否仅本目录
			}
