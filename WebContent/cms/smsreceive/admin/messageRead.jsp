...
<table valign="middle" width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		...
		<td class="tdcontent"><ext:field writeonly="true" property="senderNumber"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">接收时间</td>
		<td class="tdcontent"><ext:field writeonly="true" property="receiveTime"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap" valign="top">答复内容</td>
		<td class="tdcontent"><ext:field writeonly="true" property="replyContent"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">答复时间</td>
		<td class="tdcontent"><ext:field writeonly="true" property="replyTime"/></td>
	</tr>
</table>