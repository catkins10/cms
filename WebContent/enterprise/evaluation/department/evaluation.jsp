...
<ext:form action="/saveEvaluation" applicationName="enterprise/evaluation/department" pageName="evaluation">
	...
	<table class="evaluationTable" border="1" cellpadding="3px" cellspacing="0" style="border-collapse:collapse" bordercolor="#000000">
		<tr align="center" style="font-weight: bold">
			...
			<td nowrap="nowrap" width="100px">权重</td>
		...
		<ext:iterate id="result" indexId="resultIndex" property="results">
			<tr align="center">
				...
				<td nowrap="nowrap"><ext:field name="result" property="result"/></td>
