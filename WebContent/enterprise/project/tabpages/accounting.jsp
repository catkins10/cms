...
<div style="padding-bottom:5px">
	<input type="button" class="button" value="收款" style="width:40px" onclick="newCollect()">
</div>
<table width="100%" class="table" border="1" cellpadding="0" cellspacing="0">
	...
	<ext:iterate id="collect" property="collects">
		<tr style="cursor:pointer" valign="top" align="center" onclick="openCollect('<ext:write name="collect" property="id"/>')">
			<td align="left"><ext:write name="collect" property="clauseName"/></td>
			<td><ext:write name="collect" property="contract.contractNo"/></td>
			<td><ext:write name="collect" property="contract.contractValue" format="#.##"/></td>
			<td><ext:write name="collect" property="accountReceivable" format="#.##"/></td>
			<td><ext:write name="collect" property="invoiceAmount" format="#.##"/></td>
			<td><ext:write name="collect" property="billingDate" format="yyyy-MM-dd"/></td>
			<td><ext:write name="collect" property="receiveAmount" format="#.##"/></td>
			<td><ext:write name="collect" property="receiveDate" format="yyyy-MM-dd"/></td>
			<td><ext:write name="collect" property="remark"/></td>
		</tr>
	</ext:iterate>
</table>
...
<br>
<div style="padding-bottom:5px">
	<input type="button" class="button" value="付款" style="width:40px" onclick="newPay()">
</div>
<table width="100%" class="table" border="1" cellpadding="0" cellspacing="0">
	<tr height="23px" valign="bottom">
		<td align="center" nowrap="nowrap" class="tdtitle" width="100%">款项名称</td>
		<td align="center" nowrap="nowrap" class="tdtitle" width="80px">票额(元)</td>
		<td align="center" nowrap="nowrap" class="tdtitle" width="80px">收票时间</td>
