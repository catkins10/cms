...
<body>
<ext:form action="/saveProject" onsubmit="return formOnSubmit();">
...
<%		String[] optionTypes = {"经营部会核", "设计部会核", "设计部会核", "财务部会核", "办公室会核", "总工、总工办会核", "副经理会核", "总经理批示"};
String[] optionDepts = {"经营部", "设计部", "设计部", "财务部", "办公室", "总工、总工办", "副经理", "总经理批示"};
		for(int i=0; i<optionTypes.length; i++) {%>
	        <tr style="height: 42.5pt">
	            ...
	            <div style="line-height: 150%"><span style="line-height: 150%"><%=optionDepts[i]%>意见</span></div>
	            </td>
