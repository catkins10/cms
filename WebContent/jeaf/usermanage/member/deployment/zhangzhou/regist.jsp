...
<ext:form action="/submit" applicationName="jeaf/usermanage" pageName="member">
	...
	<table border="0" cellpadding="2" cellspacing="0" style="color:#000000; width:100%" align="center">
		...
		<tr>
			...
			<td>
				<a style="color:blue" href="#" onclick="FormUtils.sendValidateCodeSms(document.getElementsByName('cell')[0].value, 3, 60, '<ext:write property="siteId"/>');return false;">发送短信验证码</a>
