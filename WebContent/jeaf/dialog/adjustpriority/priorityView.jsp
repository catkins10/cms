...
<table class="view" width="100%" border="0" cellpadding="0" cellspacing="1">
	<ext:iterate id="column" indexId="columnIndex" property="<%=viewPackageName + ".view.columns"%>">
		<col align="<ext:write name="column" property="align"/>" width="<ext:write name="column" property="width"/>" class="<ext:mod mod="2" value="0" name="columnIndex">viewColEven</ext:mod><ext:mod mod="2" value="1" name="columnIndex">viewColOdd</ext:mod>">
	</ext:iterate>
	...
	<ext:iterate id="record" indexId="recordIndex" property="highPriorityRecords">
		<tr id="<ext:write name="record" property="id"/>" style="cursor:pointer" onclick="onSelectResult(this)" ondblclick="cleanOne()">
			<ext:iterate id="column" indexId="columnIndex" property="<%=viewPackageName + ".view.columns"%>">
