...
<%@ taglib uri="/WEB-INF/struts-ext" prefix="ext" %>
	...
	<tr>
		...
		<td><ext:field writeonly="true" property="unitBusiness.businessName"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">是否启用：</td>
		<td><ext:field writeonly="true" property="unitBusiness.enabled"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">短信号码：</td>
		<td><ext:field writeonly="true" property="unitBusiness.smsNumber"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">计费方式：</td>
		<td><ext:field writeonly="true" property="unitBusiness.chargeMode"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">价格(元)：</td>
		<td><ext:field writeonly="true" property="unitBusiness.price"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">折扣：</td>
		<td><ext:field writeonly="true" property="unitBusiness.discount"/></td>
	</tr>
	<tr>
		<td nowrap="nowrap" align="right">附加信息：</td>
		<td><ext:field writeonly="true" property="unitBusiness.postfix"/></td>
	</tr>
