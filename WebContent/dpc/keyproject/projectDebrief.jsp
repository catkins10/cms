...
<table valign="middle" width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		...
		<td class="tdcontent"><ext:field writeonly="true" property="leader"/><ext:notEmpty property="otherLeader">,<ext:field writeonly="true" property="otherLeader"/></ext:notEmpty></td>
	</tr>
	<tr>
