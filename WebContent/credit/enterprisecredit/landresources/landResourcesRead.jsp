...
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		...
		<td class="tdcontent" ><ext:write property="basis"/></td>
		<td class="tdtitle" nowrap="nowrap">处罚情况</td>
		<td class="tdcontent" ><ext:write property="result"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">处罚时间</td>
		<td class="tdcontent" colspan="3"><ext:write property="punishTime"/></td>
	</tr>
