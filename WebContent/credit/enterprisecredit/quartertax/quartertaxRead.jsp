...
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		...
		<td class="tdcontent" ><ext:write property="enterprise"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">纳税人识别号</td>
		<td class="tdcontent"><ext:write property="number"/></td>
	...
	<tr>
		...
		<td class="tdcontent"><ext:write property="taxType"/></td>
		<td class="tdtitle" nowrap="nowrap">累计欠税余额(元)</td>
		<td class="tdcontent"><ext:write property="total"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">本年欠税余额(元)</td>
		<td class="tdcontent"><ext:write property="thisYear"/></td>
		<td class="tdtitle" nowrap="nowrap">欠税时间</td>
		<td class="tdcontent"><ext:write property="oweTime"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">单位</td>
		<td class="tdcontent" colspan="3"><ext:write property="nuit"/></td>
	</tr>
