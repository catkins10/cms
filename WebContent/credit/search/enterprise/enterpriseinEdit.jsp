...
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		<td class="tdtitle" nowrap="nowrap">登记名称</td>
		<td class="tdcontent"><ext:write property="name"/></td>
		<td class="tdtitle" nowrap="nowrap">企业类别</td>
		<td class="tdcontent"><ext:write property="category"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="tdtitle" nowrap="nowrap">注册资本(万元)</td>
