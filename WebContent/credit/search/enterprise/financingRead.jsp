...
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		...
		<td class="tdcontent" ><ext:write property="projectName"/></td>
		<td class="tdtitle" nowrap="nowrap">资金需求额度</td>
		<td class="tdcontent" ><ext:write property="amount"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">可提供担保方式</td>
		<td class="tdcontent"><ext:write property="guarantyType"/></td>
	...
	<tr>
		...
		<td class="tdcontent" colspan="3"><ext:write property="purpose"/></td>
	</tr>
	<tr>
