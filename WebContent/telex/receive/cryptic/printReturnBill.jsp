...
<center>
	<div style="font-family:黑体;font-size:22px">电报清退单</div>
</center>
<br>
<table width="100%" style="table-layout:fixed; border;border-collapse:collapse;" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000">
	...
	<col width="72px">
	<tr>
		<td align="center"><b>清退人</b></td>
		<td colspan="3"><ext:write name="sign" property="signPersonName"/><ext:equal value="true" name="sign" property="agent">(代清退)</ext:equal></td>
		<td align="center"><b>所在单位</b></td>
		<td colspan="4"><ext:write name="sign" property="signPersonOrgFullName"/></td>
	</tr>
	<tr align="center">
		<td rowspan="<%=(signForm.getReturnTelegrams().size() + 2)%>"><b>清<br>退<br>电<br>报<br>列<br>表</b></td>
		<td><b>原号</b></td>
		<td><b>标题</b></td>
		<td><b>接收人</b></td>
		<td><b>发电单位</b></td>
	...
	<ext:iterate id="telegramSign"  name="sign" property="returnTelegrams">
		<tr>
			...
			<td align="center"><ext:write name="telegramSign" property="signTime" format="yyyy-MM-dd"/></td>
		</tr>
	</ext:iterate>
	<tr>
		<td colspan="8" height="<%=Math.max(20, 100-signForm.getReturnTelegrams().size()*16)%>px"></td>
	</tr>
	<ext:iterate id="telegramSign"  name="sign" property="returnTelegrams" length="1">
		<tr>
			<td align="center"><b>值班人</b></td>
			<td colspan="2"><ext:write name="telegramSign" property="returnOperatorName"/></td>
			<td align="center"><b>清退时间</b></td>
			<td colspan="2"><ext:write name="telegramSign" property="returnTime" format="yyyy-MM-dd"/></td>
			<td align="center"><b>打印时间</b></td>
			<td colspan="2"><ext:write name="sign" property="printTime" format="yyyy-MM-dd"/></td>
		</tr>
	</ext:iterate>
	<tr height="50px">
		<td align="center"><b>清退人<br>签字</b></td>
		<td colspan="8"></td>
	</tr>
</table>
</body>
