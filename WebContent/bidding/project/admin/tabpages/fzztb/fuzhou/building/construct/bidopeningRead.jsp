...
<table valign="middle" width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		...
		<td class="tdcontent"><ext:field writeonly="true" property="bidopening.room"/></td>
	</tr>
	<tr>
		...
		<td class="tdcontent"><ext:field writeonly="true" property="bidopening.endTime"/></td>
	</tr>
	<tr>
		<td class="tdtitle" valign="top" nowrap="nowrap">开标情况描述</td>
		<td class="tdcontent" colspan="3"><ext:field writeonly="true" property="bidopening.description"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">记录人</td>
		<td class="tdcontent"><ext:field writeonly="true" property="bidopening.recorder"/></td>
		<td class="tdtitle" nowrap="nowrap">监标人</td>
		<td class="tdcontent"><ext:field writeonly="true" property="bidopening.surverllant"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">招标人代表</td>
		<td class="tdcontent"><ext:field writeonly="true" property="bidopening.linkman"/></td>
		<td class="tdtitle" nowrap="nowrap">公示期限(天)</td>
		<td class="tdcontent"><ext:field writeonly="true" property="bidopening.publicLimit"/></td>
	</tr>
</table>
<br>
<b>开标明细</b>
