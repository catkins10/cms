...
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		<td class="tdtitle" nowrap="nowrap" valign="top">登记人</td>
		<td colspan="3" class="tdcontent"><ext:write property="creator"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap" valign="top">事发位置</td>
		<td colspan="3" class="tdcontent"><ext:write property="position"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap" valign="top">案件描述</td>
		<td colspan="3" class="tdcontent"><ext:write property="description"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap" valign="top">处理结果</td>
	...
	<tr>
		<td class="tdtitle" nowrap="nowrap" valign="top">备注</td>
		<td colspan="3" class="tdcontent"><ext:write property="remark"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">修复后照片上传</td>
		<td colspan="3" class="tdcontent"><ext:field property="processImages"/></td>
	</tr>
</table>