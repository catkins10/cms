...
<head>
	...
	function validate() {
		if(!validateRegistUnicomPerson(document.forms[0])) {
			return false;
		}
...
<body>
<ext:form action="/doRegistUnicomPerson" onsubmit="return validate();">
<center>
    <div id="container">
		<div id="head">
		...
		<div id="main">
			<div id="main_rim_a">
             		...
             		<table style="width:720px; color: #000000; table-layout:foxed" cellSpacing="0" cellPadding="3" align="center" border="0">
						...
						<tr>
							...
							<td align="left">
								...
								<html:text property="orgFullName" readonly="true"  styleClass="needsclass" onclick="DialogUtils.selectOrg(600, 400, false, 'orgId{id},orgFullName{fullName}', '', 'area', '', ',', '0', false, true)"/>
		                    </td>
						...
						<tr>
							<td height="24" align="right"><span style="color:#ff0000">*&nbsp;</span>电话：</td>
							<td align="left">
				...
				<div id="main_text">
					<a href="#" onClick="FormUtils.submitForm();"><img src="image/enter.jpg" border="0"></a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onClick="window.close();"> <img src="image/close.jpg" border="0" /></a>
				</div> <!--main_rim_a end-->
			</div>  <!--main end-->
