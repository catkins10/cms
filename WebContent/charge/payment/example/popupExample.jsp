...
<html>
<head>
	<title>支付：弹出页面方式</title>
	<script type="text/javascript" src="https://passport.9191edu.com/charge/payment/js/payment.js"></script>
	<script type="text/javascript">
		function payment() {
			popupPaymentPage(document.getElementsByName("applicationName")[0].value, document.getElementsByName("payReason")[0].value, document.getElementsByName("providerId")[0].value, document.getElementsByName("providerName")[0].value, document.getElementsByName("money")[0].value, document.getElementsByName("providerMoney")[0].value);
		}
