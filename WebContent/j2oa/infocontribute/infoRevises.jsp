...
<table width="100%" class="table" border="1" cellpadding="0" cellspacing="0">
	<tr align="center">
		...
		<td class="tdtitle" nowrap="nowrap" width="35%">退改稿意见</td>
		<td class="tdtitle" nowrap="nowrap" width="65%">修改后正文</td>
	...
	<ext:iterate id="revise" indexId="reviseIndex" property="revises">
		<tr valign="top" align="center">
			...
			<td class="tdcontent" align="left"><ext:field writeonly="true" name="revise" property="newBody"/></td>
