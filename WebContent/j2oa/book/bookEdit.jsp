...
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		...
		<td class="tdcontent"><ext:field property="publishingHouse"/></td>
		<td class="tdtitle" nowrap="nowrap">出版日期</td>
		<td class="tdcontent"><ext:field property="publicationDate"/></td>
	</tr>
	<tr>
		<td class="tdtitle" nowrap="nowrap">书籍页数</td>
		<td class="tdcontent"><ext:field property="pages"/></td>
