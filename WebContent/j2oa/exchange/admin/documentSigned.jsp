...
<table valign="middle" width="100%" border="1" cellpadding="0" cellspacing="0" class="table">
	...
	<tr>
		...
		<td class="tdcontent" colspan="3"><ext:field writeonly="true" property="body"/></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="tdtitle" nowrap="nowrap">签收时间</td>
		<td class="tdcontent"><ext:write property="currentUnit.signTime" format="yyyy-MM-dd HH:mm"/></td>
		<td class="tdtitle" nowrap="nowrap">签收人</td>
		<td class="tdcontent"><ext:write property="currentUnit.signPerson"/></td>
	</tr>
	<tr>
